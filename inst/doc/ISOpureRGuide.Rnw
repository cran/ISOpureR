...
\begin{figure}[!h]	
	\centering
		\includegraphics[width = 0.35\textwidth, natwidth=232,natheight=363]{Figures/network-model.jpg}
...
\begin{figure}[!h]
	\centering
		\includegraphics[width = 0.8\textwidth, natwidth=600,natheight=454]{Figures/isopure.jpg}
...
load(file.path(
		path.to.data,
		'beer.ISOpureS2model.1000.transcripts.30.patients.rounded.RData'
		)
	);
...
load(file.path(path.to.data , 'beer.tumordata.1000.transcripts.30.patients.RData'));
load(file.path(path.to.data , 'beer.normaldata.1000.transcripts.RData'));
load(file.path(path.to.data , 'beer.ISOpureS2model.1000.transcripts.30.patients.rounded.RData'));
@ 
...
require("knitr")
opts_chunk$set(fig.path='Examples/', dev='png', warning=FALSE, dpi=120, fig.align='center')
@
...
\begin{figure}[!h]
	\centering
		\includegraphics[width = 0.7\textwidth, natwidth=600,natheight=454]{Figures/tumor-normal-comparison-heatmap.png}
...
\begin{figure}[!h]
	\centering
		\includegraphics[width = 0.7\textwidth, natwidth=600,natheight=454]{Figures/cancer-normal-comparison-heatmap.png}
