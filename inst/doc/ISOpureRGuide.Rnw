...
load(file.path(path.to.data , 'beer.normaldata.500.transcripts.RData'));
load(file.path(path.to.data , 'beer.tumordata.500.transcripts.30.patients.RData'));
...
load(file.path(path.to.data , 'beer.ISOpureS1model.500.transcripts.30.patients.RData'));
ls();
...
load(file.path(
		path.to.data,
		'beer.ISOpureS2model.500.transcripts.30.patients.RData'
		)
	);
...
load(file.path(path.to.data , 'beer.tumordata.500.transcripts.30.patients.RData'));
load(file.path(path.to.data , 'beer.normaldata.500.transcripts.RData'));
load(file.path(path.to.data , 'beer.ISOpureS2model.500.transcripts.30.patients.RData'));
@ 
